...
export let role="img";
export let size = "32"; export let ariaLabel="cil indent decrease" 
</script>
...
on:mouseout
 viewBox="0 0 512 512">
  ...
  <path fill="var(--ci-primary-color, {color})" d="M160,144.909,4.473,256,160,367.091Zm-32,160L59.527,256,128,207.091Z" />
</svg>
