...
export let role="img";
export let size = "32"; export let ariaLabel="cil indent increase" 
</script>
...
on:mouseout
 viewBox="0 0 512 512">
  ...
  <path fill="var(--ci-primary-color, {color})" d="M16,144.909V367.091L171.527,256Zm32,62.182L116.473,256,48,304.909Z" />
</svg>
