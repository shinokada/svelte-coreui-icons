<script>
  ...
  export let role = 'img';
  export let size = '32';
  export let ariaLabel = 'cil arrow thick to top';
</script>
...
>
  ...
  />
  <rect width="400" height="32" x="56" y="16.002" fill="var(--ci-primary-color, {color})" />
</svg>
...
@prop export let ariaLabel = 'cil arrow thick to top';
-->
