...
>
  ...
  <g fill="none">
    ...
    <path
      fill="#FFF"
      d="M15.908 29.784l12.656 9.195-4.834 14.878 12.655-9.195 12.656 9.195-4.834-14.878 12.656-9.195H41.219l-4.834-14.877-4.834 14.877z"
    />
  </g>
</svg>
...
@prop export let ariaLabel = 'cif lr';
-->
