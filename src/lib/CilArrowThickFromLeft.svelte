<script>
  ...
  export let ariaLabel = 'cil arrow thick from left';
</script>
...
>
  ...
  />
  <rect width="32" height="400" x="17.375" y="56" fill="var(--ci-primary-color, {color})" />
</svg>
...
@prop export let ariaLabel = 'cil arrow thick from left';
-->
