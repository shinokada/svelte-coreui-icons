...
export let role="img";
export let width; export let height; export let ariaLabel="cif nz" 
</script>
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{width}" height="{height}" {role}
{...$$restProps}
...
on:mouseout
 viewBox="0 0 301 151">
  ...
  <g fill="none" fill-rule="evenodd">
    ...
    <path fill="#000" fill-rule="nonzero" stroke="#FFF" stroke-width="{width}" d="M.5.5l150 75m-150 0l150-75" mask="url(#b)"/>
    <mask id="d" fill="#fff">
      <use xlink:href="#c"/>
    </mask>
    <path fill="#000" fill-rule="nonzero" stroke="#CC142B" stroke-width="{width}" d="M.5.5l150 75m-150 0l150-75" mask="url(#d)"/>
    <path fill="#000" fill-rule="nonzero" stroke="#FFF" stroke-width="{width}" d="M75.5.5v75M.5 38h150"/>
    <path fill="#000" fill-rule="nonzero" stroke="#CC142B" stroke-width="{width}" d="M75.5.5v75M.5 38h150"/>
