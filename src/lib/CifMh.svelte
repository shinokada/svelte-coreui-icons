...
export let role="img";
export let width; export let height; export let ariaLabel="cif mh" 
</script>
...
on:mouseout
 viewBox="0 0 302 160">
  <g fill="none">
    <path fill="#00285E" stroke="#000" stroke-width=".274" d="M1 1h300v157.907H1z"/>
    <path fill="#F8991D" stroke="#000" stroke-linejoin="bevel" stroke-width=".274" d="M301 40.032L1 146.578v-5.512L301 7.895z"/>
    <path fill="#FFF" stroke="#000" stroke-linejoin="bevel" stroke-width=".274" d="M1 152.058l300-79.811V40.032L1 146.578z"/>
