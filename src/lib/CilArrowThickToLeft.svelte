<script>
  ...
  export let ariaLabel = 'cil arrow thick to left';
</script>
...
>
  ...
  />
  <rect width="32" height="400" x="16" y="56" fill="var(--ci-primary-color, {color})" />
</svg>
...
@prop export let ariaLabel = 'cil arrow thick to left';
-->
