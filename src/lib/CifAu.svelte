...
export let role="img";
export let width; export let height; export let ariaLabel="cif au" 
</script>
...
on:mouseout
 viewBox="0 0 301 151">
  ...
  <g fill="none" fill-rule="evenodd">
    ...
    <path fill="#000" fill-rule="nonzero" stroke="#FFF" stroke-width="17.578" d="M.5.5l150 75m0-75l-150 75" mask="url(#b)"/>
    <mask id="d" fill="#fff">
      <use xlink:href="#c"/>
    </mask>
    <path fill="#000" fill-rule="nonzero" stroke="red" stroke-width="9.375" d="M.5.5l150 75m0-75l-150 75" mask="url(#d)"/>
