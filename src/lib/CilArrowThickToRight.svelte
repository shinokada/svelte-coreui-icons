<script>
  ...
  export let ariaLabel = 'cil arrow thick to right';
</script>
...
>
  ...
  />
  <rect width="32" height="400" x="463.998" y="56" fill="var(--ci-primary-color, {color})" />
</svg>
...
@prop export let ariaLabel = 'cil arrow thick to right';
-->
