...
export let role="img";
export let width; export let height; export let ariaLabel="cif na" 
</script>
...
on:mouseout
 viewBox="0 0 301 201">
  ...
  <g fill="none" fill-rule="evenodd">
    ...
    <path fill="#000" fill-rule="nonzero" stroke="#FFF" stroke-width="{width}" d="M.5 200.5l300-200" mask="url(#b)"/>
    <mask id="d" fill="#fff">
      <use xlink:href="#c"/>
    </mask>
    <path fill="#000" fill-rule="nonzero" stroke="#D21034" stroke-width="{width}" d="M.5 200.5l300-200" mask="url(#d)"/>
    ...
    <circle cx="60.5" cy="55.5" r="18.333" fill="#FFCE00" fill-rule="nonzero" stroke="#003580" stroke-width="{width}"/>
  </g>
</svg>
