<script>
  ...
  export let height = ctx.height || 159;
  export let role = ctx.role || 'img';
  export let ariaLabel = 'cif fm';
</script>
...
@prop export let height = ctx.height || 159;
@prop export let role = ctx.role || 'img';
@prop export let ariaLabel = 'cif fm';
-->
