...
>
  <g fill="none" fill-rule="evenodd">
    ...
    <path
      fill="#FCE100"
      fill-rule="nonzero"
      d="M68.623 137.995l-24.385-17.854L19.887 138l9.444-28.708L4.822 91.651l30.221.111L44.247 63l9.234 28.777 30.198-.134-24.515 17.674z"
    />
    <path
      fill="#FFF"
      fill-rule="nonzero"
      ...
      stroke-width=".417"
      d="M23.075 117.976h17.566c1.413 1.586 4.567 2.232 7.57-.019 5.506-3.015 16.158.019 16.158.019l2.098-2.229-5.113-16.78-1.835-1.966s-3.933-2.36-11.405-1.573c-7.472.786-10.094-.262-10.094-.262s-6.554.786-8.39 1.704c-.202.163-2.098 2.097-2.098 2.097l-4.457 19.009z"
    />
    <path
      stroke="#000"
      stroke-linecap="round"
      stroke-linejoin="round"
      stroke-width=".417"
      d="M26.615 113.65s16.78-2.097 21.63 4.326c-2.739 1.874-5.151 2.029-7.735.132.411-.686 6.03-6.555 20.319-4.589"
    />
    <path
      fill="#000"
      fill-rule="nonzero"
...
@prop export let ariaLabel = 'cif mz';
-->
