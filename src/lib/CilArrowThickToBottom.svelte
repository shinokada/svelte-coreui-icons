<script>
  ...
  export let role = 'img';
  export let size = '32';
  export let ariaLabel = 'cil arrow thick to bottom';
</script>
...
>
  ...
  />
  <rect width="400" height="32" x="56" y="464" fill="var(--ci-primary-color, {color})" />
</svg>
...
@prop export let ariaLabel = 'cil arrow thick to bottom';
-->
