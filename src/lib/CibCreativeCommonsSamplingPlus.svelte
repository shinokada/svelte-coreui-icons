<script>
  ...
  export let ariaLabel = 'cib creative commons sampling plus';
</script>
...
@prop export let ariaLabel = 'cib creative commons sampling plus';
-->
