...
export let role="img";
export let width; export let height; export let ariaLabel="cif uy" 
</script>
...
on:mouseout
 viewBox="0 0 301 201">
  <g fill="none" fill-rule="evenodd">
    ...
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-linecap="square" stroke-width=".2" d="M53.54 66.92l3.678 5.492C42.104 83.35 51.332 89.818 40.621 93.319c6.662-6.501-1.049-7.049 4.564-20.599"/>
    ...
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-linecap="square" stroke-width=".2" d="M46.595 61.959l-1.283 6.484c-18.421-2.953-16.47 8.145-26.519 3.047 9.308.114 4.243-5.726 17.793-11.339"/>
    <path stroke="#000" stroke-width=".2" d="M43.635 61.2C28.02 65.022 26.544 74.233 18.793 71.49"/>
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-width=".2" d="M56.056 56.055l5.186 5.186-33.705 23.334L50.872 50.87l5.184 5.185-28.52 28.52"/>
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-linecap="square" stroke-width=".2" d="M45.191 53.54l-5.492 3.678c-10.938-15.114-17.406-5.887-20.907-16.597 6.501 6.661 7.049-1.049 20.599 4.564"/>
    ...
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-linecap="square" stroke-width=".2" d="M50.153 46.594l-6.485-1.283c2.953-18.421-8.145-16.47-3.047-26.519-.113 9.307 5.726 4.242 11.339 17.793"/>
    <path stroke="#000" stroke-width=".2" d="M50.911 43.634c-3.822-15.615-13.033-17.091-10.29-24.842"/>
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-width=".2" d="M56.056 56.055l-5.185 5.186-23.335-33.705L61.241 50.87l-5.185 5.185-28.52-28.52"/>
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-linecap="square" stroke-width=".2" d="M58.572 45.191l-3.678-5.492c15.114-10.938 5.887-17.406 16.597-20.907-6.661 6.501 1.049 7.049-4.563 20.599"/>
    ...
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-linecap="square" stroke-width=".2" d="M65.517 50.152l1.283-6.484c18.421 2.953 16.47-8.145 26.519-3.047-9.308-.114-4.243 5.726-17.793 11.339"/>
    <path stroke="#000" stroke-width=".2" d="M68.477 50.911c15.615-3.822 17.091-13.033 24.842-10.29"/>
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-width=".2" d="M56.056 56.055l-5.185-5.186 33.705-23.334L61.241 61.24l-5.185-5.185 28.52-28.52"/>
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-linecap="square" stroke-width=".2" d="M66.92 58.571l5.492-3.678C83.35 70.007 89.818 60.78 93.319 71.49c-6.501-6.662-7.049 1.049-20.599-4.564"/>
    ...
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-linecap="square" stroke-width=".2" d="M61.959 65.516l6.485 1.283c-2.953 18.421 8.145 16.47 3.047 26.519.114-9.307-5.726-4.243-11.339-17.793"/>
    <path stroke="#000" stroke-width=".2" d="M61.201 68.476c3.822 15.615 13.033 17.091 10.29 24.842"/>
    <path fill="#FCD116" fill-rule="nonzero" stroke="#000" stroke-width=".2" d="M56.056 56.055l5.186-5.186 23.335 33.705L50.872 61.24l5.184-5.185 28.52 28.52"/>
