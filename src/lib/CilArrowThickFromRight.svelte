<script>
  ...
  export let role = 'img';
  export let size = '32';
  export let ariaLabel = 'cil arrow thick from right';
</script>
...
>
  ...
  />
  <rect width="32" height="400" x="462.625" y="56" fill="var(--ci-primary-color, {color})" />
</svg>
...
@prop export let ariaLabel = 'cil arrow thick from right';
-->
