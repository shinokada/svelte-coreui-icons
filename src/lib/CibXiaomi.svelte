<script>
  ...
  export let role = 'img';
  export let size = '32';
  export let ariaLabel = 'cib xiaomi';
</script>
...
@prop export let ariaLabel = 'cib xiaomi';
-->
