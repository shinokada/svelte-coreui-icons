<script>
  ...
  export let role = 'img';
  export let size = '32';
  export let ariaLabel = 'cib zalando';
</script>
...
@prop export let ariaLabel = 'cib zalando';
-->
