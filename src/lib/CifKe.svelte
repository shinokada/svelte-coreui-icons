...
export let role="img";
export let width; export let height; export let ariaLabel="cif ke" 
</script>
...
on:mouseout
 viewBox="0 0 301 201">
  <g fill="none">
    ...
    <path fill="#000" stroke="#000" stroke-width=".333" d="M114.777 159.875l2.165 1.25 58.391-101.136c3.415-.915 5.29-4.163 7.165-7.41 1.25-2.165 6.25-10.826 8.417-22.079-8.662 7.503-13.662 16.163-14.912 18.329-1.875 3.247-3.75 6.495-2.835 9.91l-58.391 101.136z"/>
    ...
    <path fill="#000" stroke="#000" stroke-width=".333" d="M186.224 159.875l-2.165 1.25-58.391-101.136c-3.415-.915-5.29-4.163-7.165-7.41-1.25-2.165-6.25-10.826-8.417-22.079 8.662 7.503 13.662 16.163 14.912 18.329 1.875 3.247 3.75 6.495 2.835 9.91l58.391 101.136z"/>
