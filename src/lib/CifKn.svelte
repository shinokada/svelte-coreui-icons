...
export let role="img";
export let width; export let height; export let ariaLabel="cif kn" 
</script>
...
on:mouseout
 viewBox="0 0 301 201">
  ...
  <g fill="none" fill-rule="evenodd">
    ...
    <path fill="#000" fill-rule="nonzero" stroke="#FCD116" stroke-width="{width}" d="M.5 200.5l300-200" mask="url(#b)"/>
    <mask id="d" fill="#fff">
      <use xlink:href="#c"/>
    </mask>
    <path fill="#000" fill-rule="nonzero" stroke="#000" stroke-width="{width}" d="M.5 200.5l300-200" mask="url(#d)"/>
