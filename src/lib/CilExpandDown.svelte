<script>
  ...
  export let role = 'img';
  export let size = '32';
  export let ariaLabel = 'cil expand down';
</script>
...
>
  ...
  <path fill="var(--ci-primary-color, {color})" d="M16,496H496V368H16Zm32-96H464v64H48Z" />
  <path
...
@prop export let ariaLabel = 'cil expand down';
-->
