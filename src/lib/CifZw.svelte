...
>
  <g fill="none" fill-rule="evenodd">
    ...
    <path
      stroke="#000"
      stroke-width=".063"
      d="M23.583 85.011s7.142-.42 9.075-.42c1.932 0 19.921.022 29.958 2.343"
    />
    <path
      stroke="#000"
      stroke-width=".063"
      d="M26.105 84.87s-.716-.867-.253-2.589c.462-1.722 5.504-6.176 5.504-12.478M30.431 84.591s-.588-2.815 5.84-5.209c1.806-.546 6.974-3.445 7.142-5.797M35.587 79.649s15.766.069 28.243 2.59"
    />
    <path
      stroke="#000"
      stroke-width=".063"
      d="M39.539 77.768s5.417.185 6.3-.067c.882-.252 2.444-.907 3.065-2.754M42.751 77.832s2.898-1.506 3.465-3.465M34.002 97.993s-1.239-8.591-1.492-13.402l3.235 3.088 3.422-2.993 2.942 3.14 3.402-2.887 2.942 3.307 3.369-2.865 2.681 3.117 3.36-2.43 3.994 3.796M61.156 92.577c-12.001-1.719-28.06-1.607-28.06-1.607M27.517 61.276s9.762-4.665 11.484-5.316"
    />
    <path
      stroke="#000"
      stroke-width=".298"
      d="M32.778 87.995l3.282 2.987 2.964-2.964 2.999 3.092 3.238-2.863 2.981 3.133 3.363-2.776 2.747 3.208 3.344-2.557 3.516 3.105"
    />
...
@prop export let ariaLabel = 'cif zw';
-->
