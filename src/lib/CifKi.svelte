...
>
  <g fill="none" fill-rule="evenodd">
    ...
    <path
      ...
      stroke="#BD9C08"
      stroke-width=".6"
      d="M157.3 25.431l11.089.073c.071-.469-.951-1.403-1.822-1.539-2.808-.441-4.913.468-8.32.503l-.947.963z"
    />
    <path
      fill="#FCD116"
      fill-rule="nonzero"
      stroke="#BD9C08"
      stroke-width=".6"
      d="M135.216 22.822c2.604 3.29 7.652 5.576 12.476 5.606 6.5.04 13.707-5.22 22.425-6.831l-28.458-.586c-3.682-2.522-6.476-2.202-8.381-.639l-5.441.165c-.77.419.636 2.171 1.776 2.236l5.603.049z"
    />
    <path
      fill="#FCD116"
      fill-rule="nonzero"
      stroke="#BD9C08"
      stroke-width=".6"
      d="M148.08 20.934c-1.035-4.759-4.854-6.81-9.446-7.418-5.303-.703-17.511-1.423-25.62-3.752 3.508 3.45 10.855 5.173 15.958 5.952 5.405.825 10.667 2.027 14.837 5.176l4.271.042z"
    />
    <path
      fill="#FCD116"
      fill-rule="nonzero"
...
@prop export let ariaLabel = 'cif ki';
-->
